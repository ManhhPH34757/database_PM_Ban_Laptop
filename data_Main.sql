...
CREATE TABLE PhieuGiamGia(
	...
	GiaGiam DECIMAL(38, 20) NOT NULL,
	DieuKienHoaDon DECIMAL(38, 20) NOT NULL
)
GO
...
CREATE TABLE Laptop(
	ID INT IDENTITY(1,1) PRIMARY KEY,
	MaLaptop VARCHAR(50) UNIQUE NOT NULL,
...
CREATE TABLE BienThe(
	...
	MaBienThe VARCHAR(50) UNIQUE NOT NULL,
...
CREATE TABLE HoaDonNhap(
	...
	TongTien DECIMAL(38, 20) NOT NULL
)
GO
...
CREATE TABLE HoaDon(
	ID INT IDENTITY(1,1) PRIMARY KEY,
	MaHD VARCHAR(50) UNIQUE NOT NULL,
...
CREATE TABLE CTHoaDon(
	...
	ID_Serial INT FOREIGN KEY REFERENCES dbo.Serial(ID) ON UPDATE CASCADE UNIQUE NOT NULL
)
GO 

CREATE TABLE PhieuDoi(
	ID INT IDENTITY(1,1) PRIMARY KEY,
	MaPhieuDoi VARCHAR(50) UNIQUE NOT NULL,
	MaKH VARCHAR(20) FOREIGN KEY REFERENCES dbo.KhachHang(MaKH) NOT NULL,
	MaHD INT FOREIGN KEY REFERENCES dbo.HoaDon(ID) ON DELETE CASCADE NULL,
...
CREATE TABLE LS_HoaDon(
	ID INT IDENTITY(1,1) PRIMARY KEY,
	MaNV VARCHAR(20) FOREIGN KEY REFERENCES dbo.NhanVien(MaNV) NOT NULL,
	MaHoaDon INT FOREIGN KEY REFERENCES dbo.HoaDon(ID) NOT NULL,
...
CREATE TABLE LS_PhieuDoi(
	ID INT IDENTITY(1,1) PRIMARY KEY,
	MaNV VARCHAR(20) FOREIGN KEY REFERENCES dbo.NhanVien(MaNV) NOT NULL,
	PhieuDoi INT FOREIGN KEY REFERENCES dbo.PhieuDoi(ID) NOT NULL,
	LichSuLamViec NVARCHAR(100) NOT NULL
)
GO
