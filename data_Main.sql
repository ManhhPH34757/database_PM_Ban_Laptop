...
CREATE TABLE CTHoaDon(
	ID INT IDENTITY(1,1) PRIMARY KEY,
	MaHD VARCHAR(20) FOREIGN KEY REFERENCES dbo.HoaDon(MaHD) ON DELETE CASCADE ON UPDATE CASCADE NOT NULL,
	ID_Serial INT FOREIGN KEY REFERENCES dbo.Serial(ID) ON DELETE CASCADE ON UPDATE CASCADE NOT NULL
)
GO 
...
CREATE TABLE CTPhieuDoi(
	ID INT IDENTITY(1,1) PRIMARY KEY,
	ID_PhieuDoi INT FOREIGN KEY REFERENCES dbo.PhieuDoi(ID) ON DELETE CASCADE ON UPDATE CASCADE NOT NULL,
	ID_Serial_Old INT FOREIGN KEY REFERENCES dbo.Serial(ID) ON DELETE CASCADE ON UPDATE CASCADE NOT NULL,
	ID_Serial_New INT FOREIGN KEY REFERENCES dbo.Serial(ID) ON DELETE CASCADE ON UPDATE CASCADEE NOT NULL
)
GO 
