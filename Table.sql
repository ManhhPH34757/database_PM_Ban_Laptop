...
CREATE TABLE ThongSoKyThuat(
	MaLaptop VARCHAR(30) PRIMARY KEY,
	TenLaptop INT FOREIGN KEY REFERENCES dbo.Laptop(ID) NOT NULL,
...
CREATE TABLE LaptopNhap(
	SerialNumber VARCHAR(30) PRIMARY KEY,
	MaLaptop VARCHAR(30) FOREIGN KEY REFERENCES dbo.ThongSoKyThuat(MaLaptop) NOT NULL,
	TrangThai BIT NOT NULL
)
GO 

CREATE TABLE HoaDonNhap(
	MaDN VARCHAR(30) PRIMARY KEY,
...
CREATE TABLE ChiTietHDN(
	...
	SerialNumber VARCHAR(30) FOREIGN KEY REFERENCES dbo.LaptopNhap(SerialNumber) NOT NULL
)
GO
